...
func SubirAvatar(w http.ResponseWriter, r *http.Request) {
	// lo trataremos como un formulario de html y vendra en un parametro (archivo) llamado avatar
	file, handler, err := r.FormFile("avatar")
	if err != nil {
		http.Error(w, "Error al recibir el archivo avatar "+err.Error(), http.StatusBadRequest)
		return
	}
